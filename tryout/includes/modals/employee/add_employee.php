							...
							<div class="modal-body">
								<form method="POST" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="col-sm-6">  
											<div class="form-group">
												<label class="col-form-label">Contractor ID <span class="text-danger">*</span></label>
												<input name="employee_id" readonly type="text" value="<?php echo 'CON-'.$id; ?>" class="form-control">
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="col-form-label">Contractors Picture</label>
