...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Contractors Management System">
		<meta name="keywords" content="admin, estimates, bootstrap, business, corporate, creative, management, minimal, modern, accounts, invoice, html5, responsive, CRM, Projects">
        <meta name="author" content="Daniel Gacheru">
        <meta name="robots" content="noindex, nofollow">
        <title>Dashboard - Contractors Management System</title>
							...
							<div class="card-group m-b-30">
								<div class="card">
									<div class="card-body">
										<div class="d-flex justify-content-between mb-3">
											<div>
												<span class="d-block">New Contractors</span>
											</div>
											<div>
										...
										<p class="mb-0">Overall Contractors 218</p>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body">
										...
										<h3 class="mb-3">$1,425,300</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">Previous Month <span class="text-muted">$1,155,852</span></p>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body">
										...
										<h3 class="mb-3">$1,123,000</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">Previous Month <span class="text-muted">$1,432,000</span></p>
									</div>
								</div>
							</div>
						</div>	
